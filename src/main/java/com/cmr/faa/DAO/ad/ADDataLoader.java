...
public class ADDataLoader {
    private final static Logger log = LoggerFactory.getLogger(ADDataLoader.class);
    ...
    public List<AD> load(Table adTable) {
        ...
        System.out.println("\n\n----B E G I N  L  O A D  O F  ADs  F R O M  A C C E S S  D A T A B A S E -----------");
        for (com.healthmarketscience.jackcess.Row row :
                adTable) {
            adcount++;
            System.out.print("\r Loading: " + adcount);
            AD ad = new AD();
            ad.setAd_id(row.getInt(Constants.AD_ID_COLUMN_NAME));
    ...
    public List<AD> load(String adSpreadSheetFileName) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                ad.setAd_id((int) cell.getNumericCellValue());
    ...
    public int getSmallLargeAirplaneCount() {
        return smallLargeAirplaneCount;
    }
    ...
    public String toString() {
        ...
        String lf = "\n";
        String tab = "\t";
        StringBuilder append = sb.append(lf)
                .append("------L O A D  S U M M A R Y ------")
                .append(lf)
                .append("ADs: ")
                .append(this.getAdcount())
                .append(lf)
                .append("AirCraft ADs: ")
                .append(this.getAircraftCount())
                .append("(")
                .append(String.format("%.2f", this.getAircraftCount() / (float)this.getAdcount() *100 ))
                .append("%")
                .append(")")
                .append(lf)
                .append("Engine Ads: ")
                .append(this.getEngineCount())
                .append("(")
                .append(String.format("%.2f", this.getEngineCount() /  (float)this.getAdcount() *100 ))
                .append("%")
                .append(")")
                .append(lf)
                .append("Propeller Ads: ")
                .append(this.getPropellerCount())
                .append("(")
                .append(String.format("%.2f", this.getPropellerCount() /  (float)this.getAdcount() *100 ))
                .append("%")
                .append(")")
                .append(lf)
                .append("Appliance ADs: ")
                .append(this.getApplianceCount())
                .append("(")
                .append(String.format("%.2f", this.getApplianceCount() /  (float)this.getAdcount() *100 ))
                .append("%")
                .append(")")
                .append(lf)
                .append(lf)
                ...
                .append(this.getSmallAirplaneCount())
                .append("(")
                .append(String.format("%.2f", this.getSmallAirplaneCount() /  (float)this.getAdcount() *100 ))
                .append("%")
                .append(")")
                .append(lf)
                .append(tab)
                ...
                .append("(")
                .append(String.format("%.2f", this.getLargeAirPlaneCount() /  (float)this.getAdcount() *100 ))
                .append("%")
                .append(")").append(lf)
                .append(tab)
                .append("Large/Small Airplane ADs ")
                .append(this.getSmallLargeAirplaneCount())
                .append("(")
                .append(String.format("%.2f", this.getSmallLargeAirplaneCount() /  (float)this.getAdcount() *100 ))
                .append("%")
                .append(")")
                .append(lf)
                .append(tab)
                .append("Rotorcraft ADs ")
                .append(this.getRotorcraftCount())
                .append("(")
                .append(String.format("%.2f", this.getRotorcraftCount() /  (float)this.getAdcount() *100 ))
                .append("%")
                .append(")")
                .append(lf)
                .append(tab)
                .append("Glider ADs ")
                .append(this.getGliderCount())
                .append("(")
                .append(String.format("%.2f", this.getGliderCount() /  (float)this.getAdcount() *100 ))
                .append("%")
                .append(")")
                .append(lf)
                .append(tab)
                .append("Ballon ADs ")
                .append(this.getBallonCount())
                .append("(")
                .append(String.format("%.2f", this.getBallonCount() /  (float)this.getAdcount() *100 ))
                .append("%")
                .append(")")
                .append(lf)
                .append(lf);
    ...
    private void adjustProductSubTypeCounts(AD ad) {
        ...
        if (ad.getProductType().equals(Constants.PRODUCT_TYPE_AIRCRAFT)) {
            incrementTypeCounters(productSubType);
    ...
    private void incrementTypeCounters(String productSubType) {
